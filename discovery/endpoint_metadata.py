...
STIM_SELECT_SIGNAL_OUTCOME_GUIDANCE = {
    "signal_criteria": {
        ...
        "volume": {"operator": ">", "threshold": 100000, "description": "Signal observation weekly trading volume must exceed 100,000 actual shares traded."},
...
_ENDPOINT_METADATA_BY_PATH: dict[str, dict[str, Any]] = {
    ...
    "/v1/prices/latest": _metadata(
        ...
        resource_description="Latest weekly price row for a Stock Trends symbol, including adjusted close, weekly high/low, volume (actual shares traded), trades, and price change.",
        bazaar_output_description="Returns latest weekly price fields for a requested symbol, including symbol_exchange, weekdate, price, adj_close, pr_week_hi, pr_week_lo, volume (actual shares traded), trades, and pr_change.",
    ...
    "/v1/prices/history": _metadata(
        ...
        bazaar_output_description="Returns bounded weekly price history with weekdate, symbol_exchange, price, adjusted close, weekly high/low, volume (actual shares traded), trades, and price change fields.",
